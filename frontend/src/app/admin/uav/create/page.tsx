...
interface UAVAdminCreatePageProps {}
...
const UAVAdminCreatePage: FC<UAVAdminCreatePageProps> = ({}) => {
  ...
  return isLoadingCategories && isLoadingManifacturers ? null : (
...
export default UAVAdminCreatePage;
